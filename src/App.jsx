...
const WORKER_URL = 'https://mac-mini-1.tail065159.ts.net:8443/chat'

const MODEL = 'minimax'
const NAS_BACKUP_URL = 'https://mac-mini-1.tail065159.ts.net:8443/backup'
const NAS_SCRAPE_URL = 'https://mac-mini-1.tail065159.ts.net:8443/scrape'
